...
def tweet_home():
    if request.method == 'POST':
        try:    # succesful query 
            ...
            sentiment = predict_tweet(input_tweet)
...
def user_result():
    #data = [["Just got back from seeing @GaryDelaney in Burslem. AMAZING!! Face still hurts from laughing so much #hilarious", "Positive"],
    #        ["Police Officers....should NOT have the right to just 'shoot' human beings without provocation. It's wrong.\n\n@ORConservative @MichaelaAngelaD", "Negative"],
    #        ["Currently unfollowing anything relating to disneyworld or Florida! #holidayblues #depressing #wantogoback ðŸ˜­ðŸ’”", "Neutral"],]
    data = tweets_sentiments
    print(data)
...
# function that returns the sentiment given text & text_pipeline
